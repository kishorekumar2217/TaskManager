        ...
        <ul class="slides">
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    ...
                    <img src="http://placehold.it/250x350" alt="Aspernatur excepturi rem"/></a>
                    <p class="prod-i-info">
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/277x250" alt="Aperiam tempore"/
                    ></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/250x324" alt="Blanditiis eaque"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/250x500" alt="Excepturi ducimus"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/329x250" alt="Sit recusandae voluptas"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/250x317" alt="Consequuntur minus atque"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/250x329" alt="Nostrum nihil ipsa"/>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/250x361" alt="Non ex sapiente deserunt"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/250x361" alt="Amet tempore unde"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/250x361" alt="Neque fugiat voluptates"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/250x302" alt="Amet tempore unde"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/250x327" alt="Perspiciatis dolor"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/250x262" alt="Veritatis officiis quae"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/250x292" alt="Fuga numquam obcaecati"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/250x351" alt="Ratione magni"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img"
                    ><img src="http://placehold.it/250x301" alt="Asperiores sit sequi"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/250x322" alt="Repudiandae accusamus"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/250x266" alt="Quod praesentium illum"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/250x301" alt="Deleniti ut earum"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/250x362" alt="Voluptatem quibusdam"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/250x422" alt="Nisi provident atque"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/250x385" alt="Eveniet nobis minus possimus"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/250x288" alt="Quis ex fugiat blanditiis"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/250x279" alt="Nisi autem error"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/250x403" alt="Quod soluta corrupti"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/250x280" alt="Ipsa doloremque"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/250x409" alt="Dignissimos fuga"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/316x250" alt="Tempora ea ratione vel"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/281x250" alt="Minus sequi iste"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/265x250" alt="Dignissimos fuga voluptates totam"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/291x250" alt="Perferendis recusandae"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/277x250" alt="Officiis nihil culpa"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/295x250" alt="Distinctio modi quos"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/301x250" alt="Corrupti velit vero"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/289x250" alt="Dicta doloremque hic"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="qview-btn prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
    ...
    <div class="flexslider prod-items fr-pop-tab" id="frpoptab-tab-2">
        ...
        <ul class="slides">
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/277x250" alt="Aperiam tempore"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    <img src="http://placehold.it/250x329" alt="Nostrum nihil ipsa"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
    ...
    <div class="flexslider prod-items fr-pop-tab" id="frpoptab-tab-5">
        ...
        <ul class="slides">
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img">
                    /<img src="http://placehold.it/252x250" alt="Nisi autem error"/>
                    </a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
            ...
            <li class="prod-i">
                <div class="prod-i-top">
                    <a href="product.html" class="prod-i-img"><img src="http://placehold.it/289x250" alt="Dicta doloremque hic"/></a>
                    <p class="prod-i-info">
                        <a href="#" class="prod-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                        <a href="#" class="prod-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                        <a class="prod-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
