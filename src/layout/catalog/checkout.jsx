...
<div class="auth-wrap">
    <div class="auth-col">
        ...
        <form method="post" class="login">
            <p>
                <label for="username">Name<span class="required">*</span></label><input type="text" id="username"/>
            </p>
            <p>
                <label for="password"> <span class="required">*</span></label><input type="textarea" id="password"/>
            </p>
            <p>
                <label for="username">Phone no<span class="required">*</span></label><input type="text" id="username"/>
            </p>
            <p class="auth-submit">
